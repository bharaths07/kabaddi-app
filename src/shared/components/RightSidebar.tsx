  ...
  return (
    <aside className="gl-sidebar">
      <div className="gl-profile">
        ...
        <Link to="/profile" className="gl-profile-arrow" aria-label="Go to Profile">→</Link>
      </div>
      ...
      <div className="gl-menu-list">
        ...
        <Link to="/matches" className="gl-menu-item">Top Matches</Link>
        <Link to="/profile" className="gl-menu-item">My Profile</Link>
